...
@ExceptionHandler(ResourceNotFoundException.class)
    ...
    @ExceptionHandler(CarRepairShopApiException.class)
    public ResponseEntity<ErrorDetails> handleCarRepairShopApiException(CarRepairShopApiException exception, WebRequest webRequest){
        ErrorDetails errorDetails = new ErrorDetails(new Date(), exception.getMessage(), webRequest.getDescription(false));
